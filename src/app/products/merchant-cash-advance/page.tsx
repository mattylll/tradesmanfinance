...
const productData = getProductPage('merchant-cash-advance')!;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: productData.metaTitle,
    description: productData.metaDescription,
    url: 'https://tradesmanfinance.co.uk/products/merchant-cash-advance',
  ...
  alternates: {
    canonical: 'https://tradesmanfinance.co.uk/products/merchant-cash-advance',
  },
};

export default function MerchantCashAdvancePage() {
  return <ProductPageContent productSlug="merchant-cash-advance" />;
}

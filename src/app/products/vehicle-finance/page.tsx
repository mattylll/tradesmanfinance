...
const productData = getProductPage('vehicle-finance')!;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: productData.metaTitle,
    description: productData.metaDescription,
    url: 'https://tradesmanfinance.co.uk/products/vehicle-finance',
  ...
  alternates: {
    canonical: 'https://tradesmanfinance.co.uk/products/vehicle-finance',
  },
};

export default function VehicleFinancePage() {
  return <ProductPageContent productSlug="vehicle-finance" />;
}
